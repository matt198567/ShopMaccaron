(() => {
    ...
    function initSliders() {
        if (document.querySelector(".shares__slider")) new swiper_core_Swiper(".shares__slider", {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        document.querySelector("[data-showmore-content]");
        const setsList = document.querySelector(".sets__list");
        const itemsToShowInitially = 6;
        let visibleItemCount = itemsToShowInitially;
        const totalItems = setsList.children.length;
        function toggleItemsVisibility() {
            for (let i = 0; i < totalItems; i++) {
                const listItem = setsList.children[i];
                listItem.style.display = i < visibleItemCount ? "block" : "none";
            }
        }
        toggleItemsVisibility();
        showMoreButton.addEventListener("click", (function() {
            visibleItemCount += itemsToShowInitially;
            if (visibleItemCount >= totalItems) showMoreButton.setAttribute("hidden", true);
            toggleItemsVisibility();
        }));
    }));
    window["FLS"] = true;
